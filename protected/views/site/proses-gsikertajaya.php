...
<h3><?php echo CHtml::link('Laporan Piutang', Yii::app()->createUrl('salespos/salesposreport/create2'))?></h3>
<h3><?php echo CHtml::link('Laporan Hutang', Yii::app()->createUrl('salespos/salesposreport/create3'))?></h3>
