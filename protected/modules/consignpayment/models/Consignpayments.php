...
class Consignpayments extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id, regnum, idatetime, sdatetime, edatetime, idsupplier, discount, status, userlog, datetimelog', 'required'),
			array('total, labelcost', 'numerical'),
			...
			array('regnum, sdatetime, edatetime, idatetime, idsupplier,status, userlog, datetimelog', 'safe', 'on'=>'search'),
		);
	}
